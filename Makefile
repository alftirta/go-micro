...
up_build: build_front build_broker build_auth build_logger build_mail build_listener
...
build_listener:
	...
	cd ./back-end/listener-service && env GOOS=linux CGO_ENABLED=0 go build -o ${LISTENER_BINARY} .
	@echo "Done!"
